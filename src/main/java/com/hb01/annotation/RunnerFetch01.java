...
public class RunnerFetch01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // SQL ile
        String sqlQuery2 = "SELECT * FROM t_student01 WHERE student_name ='John Lock'";
...
//        System.out.println(uniqueResult1[0] + " : " + uniqueResult1[1] + " : " + uniqueResult1[2]);
        ...
        // HQL ile
        /*String hqlQuery2 = "FROM Student01 WHERE name='John Lock'";
        ...
        String hqlQuery3 = "FROM Student01 std WHERE std.name='John Lock'";
